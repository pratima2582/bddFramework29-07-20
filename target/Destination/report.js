...
formatter.scenario({
  ...
  "description": "",
  "id": "registration-features;user-should-be-able-to-register-successfully",
  "type": "scenario",
  "keyword": "Scenario",
  "tags": [
    {
...
formatter.match({
  "location": "MyStepDefs.verify_user_is_on_registration_page()"
});
formatter.result({
  "status": "skipped"
});
